...
$emailid=Input::email($_POST['email']);
$emcntno=Input::int($_POST['econtact']);
$gurname=Input::str($_POST['gname']);
$gurrelation=Input::str($_POST['grelation']);
$gurcntno=Input::int($_POST['gcontact']);
$caddress=Input::str($_POST['address']);
$ccity=Input::str($_POST['city']);
$cstate=$_POST['state'];
$cpincode=Input::int($_POST['pincode']);
$paddress=Input::str($_POST['paddress']);
$pcity=Input::str($_POST['pcity']);
$pstate=$_POST['pstate'];
$ppincode=Input::int($_POST['ppincode']);
...
<input type="radio" value="1" name="foodstatus"> With Food( €300 Per Month Extra)
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">EIR Code : </label>
<div class="col-sm-8">
